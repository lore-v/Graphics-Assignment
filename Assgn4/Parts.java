...
public class Parts extends Shapes {
    ...
    public void beak(Graphics g, int x, int y, int s, int t) {
        ...
        if (s == 0) {
            // upper
            dda(new point(x, y), new point((x - 5), y), Color.YELLOW, g);
            dda(new point(x, y), new point(x, (y + 3)), Color.YELLOW, g);
            dda(new point(x, (y + 3)), new point((x - 5), y), Color.YELLOW, g);

            // lower
            dda(new point(x, (y - 4)), new point((x - 4), (y - 4)), Color.YELLOW, g);
            dda(new point(x, (y - 4)), new point(x, (y - 7)), Color.YELLOW, g);
            dda(new point((x - 4), (y - 4)), new point(x, (y - 7)), Color.YELLOW, g);
        } else {
            // upper
            dda(new point(x, y), new point((x - 8), y), Color.YELLOW, g);
            dda(new point(x, y), new point(x, (y + 5)), Color.YELLOW, g);
            dda(new point(x, (y + 5)), new point((x - 8), y), Color.YELLOW, g);

            // lower
            dda(new point(x, (y - 4)), new point((x - 8), (y - 4)), Color.YELLOW, g);
            dda(new point(x, (y - 4)), new point(x, (y - 9)), Color.YELLOW, g);
            dda(new point((x - 8), (y - 4)), new point(x, (y - 9)), Color.YELLOW, g);
        }
    ...
    public void body(Graphics g, int x, int y, int s, int h) {
        ...
        if (h != 0) {
            for (int i = 0; i < 26; i = i + 3) {
                dda(new point((x - 9 + i), (y + 16 - i)), new point((x - 6 + i), (y + 24 - i)), Color.ORANGE, g);
                dda(new point((x + 9 - i), (y - 16 + i)), new point((x + 6 - i), (y - 24 + i)), Color.ORANGE, g);
            }
        ...
        // medium
            ...
            if (h != 0) {
                for (int i = 0; i < 5; i = i + 3) {
                    dda(new point((x - 5 + i), (y + i)), new point((x - 5 + i), (y + 3 + i)), Color.ORANGE, g);
                    dda(new point((x + i), (y + 4 - i)), new point((x + i), (y + 7 - i)), Color.ORANGE, g);
                    dda(new point((x - 5 + i), (y - i)), new point((x - 5 + i), (y - 3 - i)), Color.ORANGE, g);
                    dda(new point((x + i), (y - 4 + i)), new point((x + i), (y - 7 + i)), Color.ORANGE, g);
                }
            }
            ...
            // If spotted -> sp != 0
            if (sp != 0) {
                Ellipse(4, 2, Color.BLUE, x, y, 0, g);
                Ellipse(2, 1, Color.BLUE, x, y, 0, g);
            }
        }
